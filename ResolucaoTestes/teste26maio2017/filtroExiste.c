...
em linhas de texto, recebidas no stdin. Assuma a existencia de dois programas 'filtro' e 'existe' que 
enacadeados, permitem fazer a pesquisa. O primeiro descarta os casos mais óbvios que lhe chegam ao seu stdin, deixando passar os 
...
int main(int argc, char const *argv[]) {
  ...
  if(!fork()){ // tem de ser um filho a ler do stdin e a escrever pro pipe para o pai podeser seguir e esperar pela morte dos filhos
    int d = 0;
